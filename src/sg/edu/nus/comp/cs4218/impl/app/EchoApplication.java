...
public class EchoApplication implements EchoInterface {
    ...
    public String constructResult(String[] args) throws AbstractApplicationException {
        String result;
        if (args == null) {
            throw new EchoException("args is null");
    ...
    public void run(String[] args, InputStream stdin, OutputStream stdout) throws AbstractApplicationException {
        if (stdout == null) {
            throw new EchoException(ERR_NO_OSTREAM);  //NOPMD - suppressed PreserveStackTrace - Stack trace not preserved as exception is thrown
        }
        ...
        try {
            ...
            throw new EchoException(ERR_IO_EXCEPTION); //NOPMD - suppressed PreserveStackTrace - Stack trace not preserved as exception is thrown
        }
    }
}
