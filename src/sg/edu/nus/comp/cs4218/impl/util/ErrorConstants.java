...
public class ErrorConstants {
    ...
    public static final String ERR_MISSING_FLAG = "Missing flag";
    ...
    public static final String ERR_FOLDER_EXISTS = "File or directory already exists";
    public static final String ERR_CREATE_FOLDER = "Could not create folder";
