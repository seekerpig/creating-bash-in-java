...
public final class IOUtils {
    ...
    public static void closeInputStream(InputStream inputStream) throws ShellException {
        if (inputStream == System.in || inputStream == null) { //NOPMD - suppressed CompareObjectsWithEquals - Valid Comparison
            return;
        }
    ...
    public static void closeOutputStream(OutputStream outputStream) throws ShellException {
        if (outputStream == System.out || outputStream == null) { //NOPMD - suppressed CompareObjectsWithEquals - Valid Comparison
            return;
        }
    ...
    public static List<String> getLinesFromInputStream(InputStream input) throws IOException {
        ...
        // Code below will wait for end of file if no line is entered
